...
function is_the_logged_in_user_owner($post_id){
    global $connection;
    $query=("SELECT post_id FROM posts WHERE post_id={$post_id} AND post_id=".loggedInUserId()."");
    $result =  mysqli_query($connection, $query);
...
function get_all_user_posts(){
    global $connection;
    $query=("SELECT * FROM posts WHERE post_id=".loggedInUserId()."");
    $result =  mysqli_query($connection, $query);
    return $result;
}
...
function get_all_user_categories(){
    global $connection;
   $query=("SELECT * FROM categories WHERE cat_id=".loggedInUserId()."");
   $result = mysqli_query($connection, $query);
   return $result;
...
function get_all_user_published_posts(){
    global $connection;
    $query=("SELECT * FROM posts WHERE post_id=".loggedInUserId()." AND post_status='published'");
    $result =  mysqli_query($connection, $query);
    return $result;
}
...
function get_all_user_draft_posts(){
    global $connection;
    $query=("SELECT * FROM posts WHERE post_id=".loggedInUserId()." AND post_status='draft'");
    $result =  mysqli_query($connection, $query);
    return $result;
}
...
function get_all_user_approved_posts_comments(){
    ...
    $query=("SELECT * FROM posts
    INNER JOIN comments ON posts.post_id = comments.comment_post_id
    WHERE post_id=".loggedInUserId()." AND comment_status='approved'");
     $result =  mysqli_query($connection, $query);
     return $result;
}
...
function get_all_user_unapproved_posts_comments(){
    ...
    $query=("SELECT * FROM posts
    INNER JOIN comments ON posts.post_id = comments.comment_post_id
    WHERE post_id=".loggedInUserId()." AND comment_status='unapproved'");
     $result =  mysqli_query($connection, $query);
     return $result;
}
